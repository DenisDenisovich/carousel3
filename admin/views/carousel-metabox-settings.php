...
<div class="carousel3-settings">
    <div class="carousel3-shortcode-wrap" style="margin-bottom:12px;">
        <p style="margin:0 0 6px;"><strong><?php _e('Шорткод карусели', 'carousel3'); ?>:</strong></p>
        <?php if ($shortcode) : ?>
        ...
        <?php else : ?>
            <p class="description"><?php _e('Сохраните карусель, чтобы получить шорткод.', 'carousel3'); ?></p>
        <?php endif; ?>
    </div>
    <p>
        <label for="<?php echo CAROUSEL3_PLUGIN_KEY; ?>_effect">
            <?php _e('Тип анимации', 'carousel3'); ?>
        </label>
        <select id="<?php echo CAROUSEL3_PLUGIN_KEY; ?>_effect" name="<?php echo CAROUSEL3_PLUGIN_KEY; ?>_effect">
            <option value="slide" <?php selected($effect, 'slide'); ?>><?php _e('Скользящий', 'carousel3'); ?></option>
            <option value="fade" <?php selected($effect, 'fade'); ?>><?php _e('Исчезновение', 'carousel3'); ?></option>
        </select>
    </p>
    <p>
        <label>
            <input type="checkbox" name="<?php echo CAROUSEL3_PLUGIN_KEY; ?>_show_arrows" value="1" <?php checked($show_arrows, '1'); ?>>
            <?php _e('Показывать стрелки навигации', 'carousel3'); ?>
        </label>
    </p>
    <p>
        <label>
            <input type="checkbox" name="<?php echo CAROUSEL3_PLUGIN_KEY; ?>_show_dots" value="1" <?php checked($show_dots, '1'); ?>>
            <?php _e('Показывать точки навигации', 'carousel3'); ?>
        </label>
    </p>
    <p>
        <label for="<?php echo CAROUSEL3_PLUGIN_KEY; ?>_height">
            <?php _e('Высота карусели (например, 300px или 50%)', 'carousel3'); ?>
        </label>
